...
public class TileDBCloudPrepareStatement implements PreparedStatement {
  ...
  public TileDBCloudPrepareStatement(TileDBClient tileDBClient, String namespace, String query) {
  ...
  public ResultSet executeQuery() throws SQLException {
    ...
    sqlParameters.setQuery(this.query);
  ...
  public boolean execute() throws SQLException {
    this.resultSet = this.executeQuery(this.query);
    return true;
  }
