...
public class TileDBCloudResultSetMetadata implements ResultSetMetaData {
    ...
    public int getColumnType(int column) throws SQLException {
        ...
        if (valueVector instanceof IntVector || valueVector instanceof UInt2Vector){
            ...
            return Types.DOUBLE;
        } else if (valueVector instanceof BigIntVector || valueVector instanceof UInt4Vector || valueVector instanceof TimeStampVector){
            return Types.BIGINT;
        ...
        throw new RuntimeException("Type for column with index: " + column +
                " is not yet supported by this driver.");
    }
