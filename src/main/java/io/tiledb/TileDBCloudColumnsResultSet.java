...
public class TileDBCloudColumnsResultSet implements ResultSet {
  ...
  public boolean next() throws SQLException {
    columnCounter++;
    if (columnCounter < attributes.size() + dimensions.size()) {
      if (columnCounter < dimensions.size()) {
        Dimension dim = dimensions.get(columnCounter);
        this.currentColumnName = dim.getName();
        this.remarks = "Dimension";
        this.dataType = dim.getType().toString();
      } else {
        Attribute att = attributes.get(columnCounter - dimensions.size());
        this.currentColumnName = att.getName();
        this.remarks = "Attribute";
        this.dataType = att.getType().toString();
        if (att.getNullable()) this.nullable = columnNullable;
      }
      return true;
    }
    return false;
  ...
  public String getString(String columnLabel) throws SQLException {
    switch (columnLabel) {
      ...
      case "NULLABLE":
        if (this.nullable == columnNoNulls) return "No";
        else return "Yes";
      case "DATA_TYPE":
